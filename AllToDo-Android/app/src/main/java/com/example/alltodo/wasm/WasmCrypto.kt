...
object WasmCrypto {
    ...
    private const val AES_KEY_B64 = "h5eDj7nnM4A17/L1IrsbMMHsbA8YFdFL3L5ONYNkzNA="
    private val keySpec = SecretKeySpec(Base64.decode(AES_KEY_B64, Base64.DEFAULT), "AES")
